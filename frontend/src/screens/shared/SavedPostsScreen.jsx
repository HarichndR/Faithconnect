        ...
        <View style={[styles.tabBar, { borderBottomColor: theme.colors.border }]}>
            ...
            >
                <MaterialCommunityIcons
                    name={activeTab === "posts" ? "view-dashboard" : "view-dashboard-outline"}
                    size={24}
            ...
            >
                <MaterialCommunityIcons
                    name={activeTab === "reels" ? "movie-play" : "movie-play-outline"}
                    size={24}
        ...
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View style={{ paddingTop: insets.top }}>
                <View style={styles.screenHeader}>
                    ...
                    <Text style={[styles.headerTitle, { color: theme.colors.text }]}>Saves</Text>
                    <View style={{ width: 24 }} />
                </View>
            </View>
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            ...
                            <Text style={[styles.emptyText, { color: theme.colors.textSecondary }]}>No saved posts</Text>
                        </View>
                    }
                />
            ) : (
                <FlatList
                    key="saved-reels-grid"
                    data={reels}
                    keyExtractor={i => i._id}
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            ...
                            <Text style={[styles.emptyText, { color: theme.colors.textSecondary }]}>No saved reels</Text>
                        </View>
                    }
                />
            )}
